...
const LeetCodeEvaluator = () => {
    ...
    const handleDownload = () => {
        ...
        // Include the local date and time in the file name
        XLSX.writeFile(workbook, `report_${formattedDate}.xlsx`);
    };
    ...
    return (
        <>
            ...
            <Container>
                <b><a href="/src/assets/demo.xlsx" style={{textDecoration:"none"}}>Please select excel file</a></b><br />
